...
public class UserTest2 {
	...
	static int i=1, j=0, k=0, LastRow2;
	...
	public static void readExcel() throws IOException, InterruptedException{
		...
		public static void webshopLogin() throws InterruptedException {
			...
			public static void excelwrite2() throws IOException {
				//path = System.getProperty("user.dir");
				
				if(k==0) {
					workbook1 = new XSSFWorkbook();
					sheet1 = workbook1.createSheet("Sheet1");
					System.out.println("Sheet does not exist for excelwrite2!");
					k = 1;
					}
				...
				cell.setCellValue("New User Registered");
			...
			public static void excelwrite1() throws IOException {
				...
				if(k==0) {
					workbook1 = new XSSFWorkbook();
					sheet1 = workbook1.createSheet("Sheet1");
					System.out.println("Sheet does not exist for excelwrite1!");
					k = 1;
						}
				sheet1 = workbook1.getSheet("Sheet1");
				
				XSSFRow row  = sheet1.createRow(i);
				System.out.println("Value of k in the excelwrite fn is :"+i);
				XSSFCell cell;
				
				cell = row.createCell(j+6);
				cell.setCellValue("Registered User");
